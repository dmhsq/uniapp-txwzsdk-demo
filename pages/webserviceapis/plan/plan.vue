		...
		<view class="content">
			...
			<view>
				...
				<label class="radio" style="margin-right: 30rpx;">
					<radio value="driving" checked="true"  color="#FFCC33" style="transform:scale(0.7)"/>驾车
				</label>
				<label class="radio">
					<radio value="walking" color="#FFCC33" style="transform:scale(0.7)"/>步行
				</label>
				<label class="radio" style="margin-right: 30rpx;">
					<radio value="bicycling"  color="#FFCC33" style="transform:scale(0.7)"/>骑车
				</label>
				</radio-group>
			</view>
			<button type="primary" @click="test()">点击规划</button>
		</view>
